...
public class BadmintonTyper4
{    
    public BadmintonTyper4(){}
    
    public static void main(String [] args)
    {
        BadmintonTyper4 bt4 = new BadmintonTyper4();
        bt4.run();
    }
...
class BadmintonTyperHolder1 extends JPanel
{
    ...
    public BadmintonTyperHolder1()
    {
        ...
        blp = new BaddyLearnPanel(this, cards, x);
...
{
    private BadmintonTyperHolder1 panelCards; //This instance is used to switch
    ...
    public BaddyStartPanel(BadmintonTyperHolder1 panelCardsIn, CardLayout cardsIn)
    {
...
class BaddyDirectionPanel extends JPanel
{
    ...
    public BaddyDirectionPanel(BadmintonTyperHolder1 panelCardsIn, CardLayout cardsIn)
    {
        panelCards = panelCardsIn;
        cards = cardsIn;
        setLayout(new BorderLayout());
...
class BaddySouthButtonPanel extends JPanel
{
    ...
    public BaddySouthButtonPanel(BadmintonTyperHolder1 panelCardsIn, CardLayout cardsIn)
    {
        panelCards = panelCardsIn;
        cards = cardsIn;
...
class BaddyPlayPanel extends JPanel
{
    ...
    public BaddyPlayPanel(BadmintonTyperHolder1 panelCardsIn, CardLayout cardsIn, int yIn)
    {
        y = yIn;
    ...
    {    
        private BadmintonTyperHolder1 panelCards; //This instance is used to
        //switch between the Card Layouts
        private CardLayout cards; //This instance is used to switch between the
                                  //Card Layouts
        
        public BaddySouthPlayPanel(BadmintonTyperHolder1 panelCardsIn, CardLayout cardsIn)
        {
    ...
    class BaddyFieldPanel extends JPanel
    {
        ...
        public BaddyFieldPanel(BadmintonTyperHolder1 panelCardsIn , CardLayout cardsIn)
        {
            panelCards = panelCardsIn;
            cards = cardsIn;
    ...
    class BaddyPlayLabels extends JPanel
    {
        ...
        // the game
        public BaddyPlayLabels(BadmintonTyperHolder1 panelCardsIn, CardLayout cardsIn)
        {
            panelCards = panelCardsIn;
            cards = cardsIn;
...
class BaddySetText extends JPanel
{
...
class BaddyLearnPanel extends JPanel
{
    ...
    public BaddyLearnPanel(BadmintonTyperHolder1 panelCardsIn, CardLayout cardsIn, int scoreIn)
    {
        setLayout(new BorderLayout());
        panelCards = panelCardsIn;
        cards = cardsIn;
...
class BaddyScoreBoardPanel extends JPanel
{
    ...
    public BaddyScoreBoardPanel(BadmintonTyperHolder1 panelCardsIn, CardLayout cardsIn)
    {
        panelCards = panelCardsIn;
        cards = cardsIn;
        panelCards = panelCardsIn;
        ...
        back = new JButton("Back");
        JTextArea scoreInfo = new JTextArea("To see the past scores of this game"+
					" you can go to the pastScores.txt file. If you would like to play again"+
					"the click on the button to your right. If you want to continue learning"+
					"how to type faster you can click the button to your left");
        ...
        add(next, BorderLayout.EAST);
        add(back, BorderLayout.WEST);
        add(scoreInfo, BorderLayout.CENTER);
    }
