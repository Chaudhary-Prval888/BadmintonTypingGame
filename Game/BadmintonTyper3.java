...
// animations for the big game.Lear
...
class BadmintonTyperHolder extends JPanel
{
    public BadmintonTyperHolder()
    {
        ...
        BaddyLearnPanel blp = new BaddyLearnPanel(this, cards, x);
    ...
    class TimerActionListener implements ActionListener
    {
        ...
        public void actionPerformed( ActionEvent evt)
        {
            ...
            if (hearts == 0)
            {
               timer.stop();
               printScoresToFile();
               BaddyLearnPanel bspl = new BaddyLearnPanel(panelCards, cards, score);
...
class BaddyLearnPanel extends JPanel
{
    ...
    public BaddyLearnPanel(BadmintonTyperHolder panelCardsIn, CardLayout cardsIn, int scoreIn)
    {
        ...
        //String gameOverStr = new String("Game Over                        Your Score is: " +score);
        JLabel gameOver = new JLabel("Game Over                        Your Score is: ");
