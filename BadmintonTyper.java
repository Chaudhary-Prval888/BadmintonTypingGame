...
public class BadmintonTyper {
    public BadmintonTyper() {
    }

    public static void main(String[] args) {
        BadmintonTyper bt = new BadmintonTyper();
        bt.run();
    }
...
// This class holds all the panels of the program and intializes the card
// layout.
...
class BaddyPlayPanel extends JPanel {
    ...
    // This method uses a for loop to load all the words from the different text
    // files
    ...
    class BaddyFieldPanel extends JPanel {
        ...
        class baddyTextFieldListener implements ActionListener {
            // This method listens to the textfield listener and depending on whether
